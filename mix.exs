defmodule SaasTemplate.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind saas_template", "esbuild saas_template"],
      "assets.deploy": [
        "tailwind saas_template --minify",
        "esbuild saas_template --minify",
        "phx.digest"
      ]
    ]
  end
