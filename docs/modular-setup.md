...
mix saas_template.gen.stripe --yes
```
...
```bash
# Admin & Security
mix saas_template.gen.admin_password
mix saas_template.gen.oauth_github
...
# Marketing & Growth
mix saas_template.gen.waitlist
...
- Use `mix help saas_template.gen.FEATURE` for specific command help

## Advanced Usage

### Custom Feature Development

You can create your own generators by following the existing patterns in `lib/saas_template/generators/`. Each generator should:
