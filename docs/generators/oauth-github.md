...
```bash
mix saas_template.gen.oauth_github --yes
```
...
- `lib/saas_template/accounts/user.ex` - Schema and changeset updates
- `lib/saas_template/accounts.ex` - Context function addition
- `lib/saas_template_web/router.ex` - Route additions
- `lib/saas_template_web/live/user_live/login.ex` - UI button addition
