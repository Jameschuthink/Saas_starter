defmodule Mix.Tasks.SaasTemplate.Setup do
  @moduledoc """
  ...
  defp prompt_for_project_name do
    ...
    puts_light_black("Current project name: SaasTemplate")
  ...
  defp generate_waitlist do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.waitlist", "--yes"],
  ...
  defp generate_analytics do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.analytics", "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp generate_error_tracker do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.error_tracker", "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp generate_google_oauth do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.oauth_google", "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp generate_github_oauth do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.oauth_github", "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp generate_lemonsqueezy do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.lemonsqueezy", "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp generate_organisations do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.organisations", "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp generate_organisations_test do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.organisations_test", "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp setup_admin_password(admin_password) do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["saas_template.gen.admin_password", "--password", admin_password, "--yes"],
          stderr_to_stdout: true
        )
  ...
  defp rename_project(project_name) do
    try do
      ...
      {output, exit_code} =
        System.cmd(
          "mix",
          ["rename", "SaasTemplate", project_name],
          stderr_to_stdout: true
        )
  ...
  defp display_llm_config(wants_llm) do
    if wants_llm do
      ...
      puts_light_black("  • Example usage: SaasTemplate.AI.example_query()")
    end
  end
  ...
  defp display_payment_config(payment_processor) do
    case payment_processor do
      "stripe" ->
        ...
        puts_light_black("  • Example: SaasTemplate.Purchases.list_purchases()")
