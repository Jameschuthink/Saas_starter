defmodule Mix.Tasks.SaasTemplate.Gen.AdminPassword do
  @moduledoc """
  ...
  This task updates the admin password configuration for basic auth protection.
      ...
      $ mix saas_template.gen.admin_password --password "my_secure_password"
  ...
  defp update_config_file(igniter) do
    ...
    Igniter.update_file(igniter, config_path, fn source ->
      ...
      if String.contains?(content, "System.get_env(\"ADMIN_PASSWORD\")") do
        ...
        pattern = ~r/(config :saas_template, :basic_auth, username: "admin", password: )"[^"]*"/
        ...
        if Regex.match?(pattern, content) do
          ...
          if Regex.match?(import_pattern, content) do
            ...
            config :saas_template, :basic_auth, username: "admin", password: System.get_env("ADMIN_PASSWORD", "admin123")
