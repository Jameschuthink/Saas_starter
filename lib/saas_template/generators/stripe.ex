defmodule Mix.Tasks.SaasTemplate.Gen.Stripe do
  @moduledoc """
  ...
  defp create_stripe_webhook_controller(igniter) do
    controller_content = """
    defmodule SaasTemplateWeb.StripeWebhookController do
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template_web/controllers/stripe_webhook_controller.ex",
      controller_content
    )
  end
  ...
  defp print_completion_notice(igniter) do
    ...
    - lib/saas_template_web/controllers/stripe_webhook_controller.ex - Webhook handler
    ...
    SaasTemplate.Purchases.get_purchase_by_payment_intent("pi_123")
