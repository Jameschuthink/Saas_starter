defmodule Mix.Tasks.SaasTemplate.Gen.Polar do
  @moduledoc """
  ...
  defp create_polar_webhook_handler(igniter) do
    handler_content = """
    defmodule SaasTemplateWeb.PolarWebhookController do
      ...
      defp verify_webhook_signature(conn, params) do
        ...
        webhook_secret = Application.get_env(:saas_template, :polar_webhook_secret)
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template_web/controllers/polar_webhook_controller.ex",
      handler_content
    )
  end
    ...
    Igniter.update_file(igniter, "lib/saas_template_web/router.ex", fn source ->
      ...
      if String.contains?(content, "PolarWebhookController") do
        ...
        updated_content =
          String.replace(
            content,
            ~r/  # scope "\/api", SaasTemplateWeb do\n  #   pipe_through :api\n  # end/,
  ...
  defp create_migration(igniter) do
    ...
    migration_content = """
    defmodule SaasTemplate.Repo.Migrations.AddPolarPurchases do
      use Ecto.Migration
  ...
  defp create_webhook_handler_test(igniter) do
    test_content = """
    defmodule SaasTemplateWeb.PolarWebhookControllerTest do
    ...
    Igniter.create_new_file(
      igniter,
      "test/saas_template_web/polar_webhook_controller_test.exs",
      test_content
    )
  end
  ...
  defp print_completion_notice(igniter) do
    ...
    - lib/saas_template_web/controllers/polar_webhook_controller.ex - Webhook handler
    ...
    - lib/saas_template_web/router.ex with webhook route
    ...
    SaasTemplate.Purchases.get_purchase_by_polar_order_id("po_123456")

    # Get purchase by Polar checkout ID
    SaasTemplate.Purchases.get_purchase_by_polar_checkout_id("ch_123456")
