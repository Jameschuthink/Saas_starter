defmodule Mix.Tasks.SaasTemplate.Gen.ErrorTracker do
  @moduledoc """
  ...
  - Creates the error tracker migration
      ...
      $ mix saas_template.gen.error_tracker
  ...
  defp create_error_tracker_migration(igniter) do
    ...
    migration_content = """
    defmodule SaasTemplate.Repo.Migrations.AddErrorTracker do
      use Ecto.Migration
  ...
  defp print_completion_notice(igniter) do
    ...
    3. Error tracking will automatically capture:
