defmodule Mix.Tasks.SaasTemplate.Gen.Organisations do
  @moduledoc """
  ...
  - Generates database migrations for organisations and memberships
      ...
      $ mix saas_template.gen.organisations
  ...
  defp create_organisation_schema(igniter) do
    organisation_content = """
      defmodule SaasTemplate.Organisations.Organisation do
        use SaasTemplate.Schema
        import Ecto.Changeset

        alias SaasTemplate.Accounts.User
        alias SaasTemplate.Organisations.OrganisationMember
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template/organisations/organisation.ex",
      organisation_content
    )
  end
  ...
  defp create_organisation_member_schema(igniter) do
    ...
    defmodule SaasTemplate.Organisations.OrganisationMember do
      use SaasTemplate.Schema
      import Ecto.Changeset

      alias SaasTemplate.Accounts.User
      alias SaasTemplate.Organisations.Organisation
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template/organisations/organisation_member.ex",
      organisation_member_content
    )
  end
  ...
  defp create_organisation_invitation_schema(igniter) do
    ...
    defmodule SaasTemplate.Organisations.OrganisationInvitation do
      use SaasTemplate.Schema
      import Ecto.Changeset
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template/organisations/organisation_invitation.ex",
      organisation_invitation_content
    )
  end
  ...
  defp create_organisations_live_new(igniter) do
    new_content = """
    defmodule SaasTemplateWeb.OrganisationsLive.New do
    use SaasTemplateWeb, :live_view

    alias SaasTemplate.Organisations
    alias SaasTemplate.Organisations.Organisation
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template_web/live/organisations_live/new.ex",
      new_content
    )
  end
  ...
  defp create_organisations_live_manage(igniter) do
    manage_content = """
    defmodule SaasTemplateWeb.OrganisationsLive.Manage do
    use SaasTemplateWeb, :live_view

    alias SaasTemplate.Organisations
    alias SaasTemplate.Accounts
    alias SaasTemplate.Accounts.Scope
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template_web/live/organisations_live/manage.ex",
      manage_content
    )
  end
  ...
  defp create_organisations_live_invitation(igniter) do
    invitation_content = """
    defmodule SaasTemplateWeb.OrganisationsLive.Invitation do
    use SaasTemplateWeb, :live_view
      ...
      token ->
        case Organisations.accept_invitation(token) do
          {:ok, user} ->
            ...
            case SaasTemplate.Accounts.deliver_login_instructions(user, &url(~p"/users/log-in/\#{&1}")) do
              {:ok, _} ->
                {:noreply,
                 socket
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template_web/live/organisations_live/invitation.ex",
      invitation_content
    )
  end
  ...
  defp create_migrations(igniter) do
    ...
    defmodule SaasTemplate.Repo.Migrations.CreateOrganisationsAndMembers do
    use Ecto.Migration
    ...
    defmodule SaasTemplate.Repo.Migrations.CreateOrganisationInvitations do
    use Ecto.Migration
  ...
  defp update_user_auth(igniter) do
    Igniter.update_file(igniter, "lib/saas_template_web/user_auth.ex", fn source ->
      ...
      if String.contains?(content, "assign_org_to_scope") do
        ...
        content_with_alias =
          String.replace(
            content,
            "alias SaasTemplate.Accounts\n",
            "alias SaasTemplate.{Accounts, Organisations}\n"
          )
        ...
        on_mount_functions =
          "\n" <>
            ...
            "          if org = SaasTemplate.Organisations.get_by_user_id(user.id) do\n" <>
      ...
      if String.contains?(content, "OrganisationsLive.Manage") do
        ...
        new_live_sessions =
          "live_session :current_user,\n" <>
            "      on_mount: [\n" <>
            "        {SaasTemplateWeb.UserAuth, :mount_current_scope}\n" <>
            "      ] do\n" <>
            ...
            "      on_mount: [\n" <>
            "        {SaasTemplateWeb.UserAuth, :require_authenticated},\n" <>
            "        {SaasTemplateWeb.UserAuth, :assign_org_to_scope}\n" <>
            "      ] do\n" <>
            ...
            "        {SaasTemplateWeb.UserAuth, :require_authenticated},\n" <>
            "        {SaasTemplateWeb.UserAuth, :assign_org_to_scope},\n" <>
            "        {SaasTemplateWeb.UserAuth, :require_organisation}\n" <>
            "      ] do\n" <>
  ...
  defp create_organisations_context(igniter) do
    ...
    defmodule SaasTemplate.Organisations do
    @moduledoc \"\"\"
    The Organisations context.
    \"\"\"

    import Ecto.Query, warn: false
    alias SaasTemplate.Repo

    alias SaasTemplate.Accounts.User
    alias SaasTemplate.Organisations.Organisation
    alias SaasTemplate.Organisations.OrganisationMember
    alias SaasTemplate.Organisations.OrganisationInvitation
    alias SaasTemplate.Accounts.UserNotifier
    ...
    Igniter.create_new_file(
      igniter,
      "lib/saas_template/organisations.ex",
      organisations_content
    )
  end

  defp update_user_notifier(igniter) do
    Igniter.update_file(igniter, "lib/saas_template/accounts/user_notifier.ex", fn source ->
      content = Rewrite.Source.get(source, :content)
  ...
  defp update_user_schema(igniter) do
    Igniter.update_file(igniter, "lib/saas_template/accounts/user.ex", fn source ->
      content = Rewrite.Source.get(source, :content)

      if String.contains?(content, "alias SaasTemplate.Organisations.Organisation") do
  ...
  defp update_scope_module(igniter) do
    Igniter.update_file(igniter, "lib/saas_template/accounts/scope.ex", fn source ->
      content = Rewrite.Source.get(source, :content)
  ...
  defp print_completion_notice(igniter) do
    ...
    - SaasTemplate.Organisations context with full CRUD operations
    ...
    ### Files Created:
    - lib/saas_template/organisations.ex - Main context module
    - lib/saas_template/organisations/organisation.ex - Organisation schema
    - lib/saas_template/organisations/organisation_member.ex - Membership schema
    - lib/saas_template/organisations/organisation_invitation.ex - Invitation schema
    - lib/saas_template_web/live/organisations_live/manage.ex - Management interface
    - lib/saas_template_web/live/organisations_live/new.ex - Organisation creation
    - lib/saas_template_web/live/organisations_live/invitation.ex - Invitation acceptance
    ...
    - lib/saas_template/accounts/user.ex - Added organisation relationships
    - lib/saas_template/accounts/scope.ex - Added organisation context
    - lib/saas_template/accounts/user_notifier.ex - Added invitation emails
    - lib/saas_template_web/router.ex - Added organisation routes
    - lib/saas_template_web/user_auth.ex - Added organisation auth hooks
    - lib/saas_template_web/components/layouts.ex - Added organisation navigation
    ...
    4. Customize the invitation email template in:
       - `lib/saas_template/accounts/user_notifier.ex`
    ...
    # Check permissions
    if SaasTemplate.Accounts.Scope.can_manage_organisation?(socket.assigns.current_scope) do
