defmodule SaasTemplate.Accounts do
  @moduledoc """
  ...
  alias SaasTemplate.Accounts.{User, UserToken, UserNotifier}
  ...
  See `SaasTemplate.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `SaasTemplate.Accounts.User.password_changeset/3` for a list of supported options.
